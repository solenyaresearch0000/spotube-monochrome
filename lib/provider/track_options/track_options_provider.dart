...
import 'package:spotube/components/dialogs/download_folder_dialog.dart';
  ...
  Future<void> action(
    ...
    switch (value) {
      ...
      case TrackOptionValue.download:
        ...
        final destinationDir = await showDownloadFolderPicker(context, ref);
        if (destinationDir == null) break; // cancelled
